...
- TypeScript 5, React 19, Next.js 16 + TailwindCSS v4, SCSS modules, lucide-react (ArrowUpRight/Check), CSS transforms (rotate) for tilted card stack, fixed-position decorative shapes (010-spaces-access-page)
- N/A — static marketing page, no persistence (010-spaces-access-page)
